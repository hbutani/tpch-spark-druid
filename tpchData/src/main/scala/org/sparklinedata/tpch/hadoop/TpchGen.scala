...
trait TpchGen {
  ...
  def tableDir(tName: String) = s"$outputDir/$tName/"
  ...
  lazy val regionDF = sqlContext.table("region").cache
  ...
  lazy val nationDF = sqlContext.table("nation").cache
  ...
  lazy val rawCustomerDF = {
    val c = sqlContext.table("customer")
    c.registerTempTable("rawCustomer")
    c
  }
  ...
  lazy val partDF = sqlContext.table("part")
  ...
  lazy val rawSupplierDF = {
    val c = sqlContext.table("supplier")
    c.registerTempTable("rawSupplier")
    c
  }
  ...
  lazy val rawPartSupplierDF = {
    val c = sqlContext.table("partsupp")
    c.registerTempTable("rawPartsupp")
    c
  }
  ...
  lazy val orderDF = sqlContext.table("orders")
  ...
  lazy val lineitemDF = {
    val d = sqlContext.table("lineitem")
